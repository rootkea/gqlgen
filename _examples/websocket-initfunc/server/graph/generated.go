...
type ComplexityRoot struct {
	...
	Mutation struct {
		PostAnnouncement func(childComplexity int, content string) int
	...
	Subscription struct {
		Announcement func(childComplexity int, subscriber string) int
...
type MutationResolver interface {
	...
	PostAnnouncement(ctx context.Context, content string) (string, error)
}
type QueryResolver interface {
	Foo(ctx context.Context, id string) (string, error)
}
type SubscriptionResolver interface {
	Subscribe(ctx context.Context, subscriber string) (<-chan string, error)
	Announcement(ctx context.Context, subscriber string) (<-chan string, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.postAnnouncement":
		...
		args, err := ec.field_Mutation_postAnnouncement_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.PostAnnouncement(childComplexity, args["content"].(string)), true
	...
	case "Subscription.announcement":
		if e.complexity.Subscription.Announcement == nil {
			break
		}

		args, err := ec.field_Subscription_announcement_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Subscription.Announcement(childComplexity, args["subscriber"].(string)), true
...
func (ec *executionContext) field_Mutation_postAnnouncement_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
...
func (ec *executionContext) field_Subscription_announcement_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["subscriber"]; ok {
...
func (ec *executionContext) _Mutation_postAnnouncement(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().PostAnnouncement(rctx, fc.Args["content"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Subscription_announcement(ctx context.Context, field graphql.CollectedField) (ret func(ctx context.Context) graphql.Marshaler) {
	fc, err := ec.fieldContext_Subscription_announcement(ctx, field)
	if err != nil {
		return nil
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Subscription().Announcement(rctx, fc.Args["subscriber"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return nil
...
func (ec *executionContext) fieldContext_Subscription_announcement(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Subscription",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Subscription_announcement_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return
	}
	return fc, nil
...
func (ec *executionContext) _Subscription(ctx context.Context, sel ast.SelectionSet) func(ctx context.Context) graphql.Marshaler {
	...
	case "announcement":
		return ec._Subscription_announcement(ctx, fields[0])
	default:
